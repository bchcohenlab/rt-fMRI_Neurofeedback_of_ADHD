...
acc_mask = currPath+'/template_masks/thr_Precentral_Gyrus_fsl_atlas.nii.gz'
...
nib.save(z_map_bin, os.path.join(currPath, 'subjects', subjID, 'motorcortex_mask_subj_space.nii.gz'))